...
declare global {
  ...
  const TodayCardsProvider: typeof import('./contexts/AcitiveTodo')['TodayCardsProvider']
  const cn: typeof import('./lib/utils')['cn']
  const createRef: typeof import('react')['createRef']
  const forwardRef: typeof import('react')['forwardRef']
  const getUserInfo: typeof import('./lib/StroreLib')['getUserInfo']
  ...
  const useTodayCards: typeof import('./contexts/AcitiveTodo')['useTodayCards']
...
declare global {
  // @ts-ignore
  export type { ActiveTodoContextType, ArchiveTodoContextType } from './contexts/types'
