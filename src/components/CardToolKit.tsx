    ...
    return (
        <div className="flex items-center gap-2 px-2 py-2 bg-gray-100 rounded-t-lg"> {/* 修改 gap-2→gap-3，py-1→py-2 */}
            ...
            <div className="flex items-center gap-1 group">
                ...
                <span className="text-sm text-gray-600 hidden group-hover:inline transition-opacity delay-2000">
                    {timestampToDate(todo.createTime || 0,'YYYY-MM-DD HH:mm:ss')}
                </span>
            </div>
            ...
            <div className="flex items-center gap-1 group">
                ...
                <span className="text-sm text-gray-600 hidden group-hover:inline transition-opacity delay-1000">
                    {timestampToDate(todo.dueTime || 0,'YYYY-MM-DD HH:mm:ss')}
                </span>
            </div>
            ...
            {/* 新增完成按钮 */}
            <SquareCheckBig className="h-5 w-5 text-green-400 hover:text-green-600 cursor-pointer" onClick={onComplete} />
